...
def get_callback_btns(
        *,                                                      # запрект на передачу не именнованных аргументов
        btns: dict[str, str],                                   # Параметр принимает словарь, ключ - текст на кнопке, значение - параметры которые будут отправляться при нажатии на кнопку
        sizes: tuple[int] = (2,)):                              # Расположение кнопок
